...
import './Contact.css';
import { HeadingH2, HeadingH5, ContactWrapper, ContactContainer, ContactDetails, ContactDetails1} from './Contact';
...
const Contactus = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm("Cryptoacres", "template_76edv1p", form.current, "gFA22Q0LhYPytTaBO")
          .then((result) => {
            ...
            <Column1>
              <div className ="contact_options">
                  <article className="contact__option">
                      ...
                      <a href="mailto:sharlwadhwa@gmail.com" target="blank">Send Message</a>
                  </article>
                  <article className="contact__option">
                  ...
                  <article className="contact__option">
                      ...
                      <a href="https://api.whatsapp.com/send?phone+919766093436" target="blank">Send Message</a>
                  </article>
                </div>
              </Column1>
              <Column2>
